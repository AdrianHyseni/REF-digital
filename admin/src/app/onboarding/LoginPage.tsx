    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-6">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1 text-center">Staff dashboard</p>
        </div>
        ...
        <div className="mt-8 text-xs text-gray-400 bg-gray-100 rounded-xl p-3 leading-relaxed">
          ...
          <p>staff.romania@ref.org / demo1234</p>
          <p>staff.kosovo@ref.org / demo1234</p>
        </div>
      </div>
    </div>
  );
